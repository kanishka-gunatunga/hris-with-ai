            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="mb-sm-0 dashboard-title">Add Resignation</h4>
                ...
                <div class="col-xxl-12">
                    <form action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <label class="form-label text-[#556476] font-medium">Resignation
                                                    Date</label>
                                                <div class="position-relative">
                                                    <input name="resignation_date" value="{{ old('resignation_date') }}"
                                                        type="text" class="form-control flatpickr-input active"
                                                        data-provider="flatpickr" data-date-format="n/j/Y"
                        ...
                        <div class="fixed-bottom bg-white border-top p-3 d-flex justify-content-between align-items-center"
                            ...
                            <button type="submit" class="btn btn-theme-orange px-5 py-2">Save as Resignation</button>
                        </div>
