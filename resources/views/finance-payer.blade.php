            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="mb-sm-0 dashboard-title">Payers</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Dashboard</a></li>
                                <li class="breadcrumb-item active">Payers</li>
                            </ol>
                        </div>
                ...
                <div class="col-lg-12">
                    <div class="card-theme">
                        <div class="card-header d-flex align-items-center justify-content-between">
                            ...
                            <a href="{{url('add-payer')}}" class="btn btn-theme-orange">Add Payer</a>
                        </div>
                                ...
                                <table id="buttons-datatables" class="display table konnect-table mb-0"
                                   ...
                                   ?>
                                        <tr>
                                            ...
                                            <td class="ps-4">{{$payer->name}} </td>
                                            <td class="">{{$payer->telephone}} </td>
                                            {{-- <td class="">{{$payer->created_at}} </td> --}}
                                            <td class="text-center">
                                                <div class="d-flex justify-content-center gap-2">
                                                    <a href="{{ url('edit-finance-payer/' . $payer->id) }}"
                                                    ...
                                                    <a href="{{ url('delete-finance-payer/' . $payer->id) }}"
