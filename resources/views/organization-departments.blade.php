...
<div class="main-content">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="mb-sm-0 dashboard-title">Departments</h4>
                ...
                <div class="col-lg-12">
                    <div class="card card-theme shadow-none rounded-3 border-0">
                        <div
                            ...
                            <h5 class="card-title mb-0 dashboard-title">Departments List</h5>
                            <link href="https://fonts.googleapis.com/css2?family=Roboto:wght@400;700&display=swap"
                                rel="stylesheet">
                            <a href="{{url('add-organization-department')}}" class="btn btn-theme-orange">Add
                                Department</a>
                        </div>
    ...
    $emp_name = OtherHODDetails::where('user_id', $department->employee)->value('name');
    $location_name = OrganizationLocations::where('id', $department->location)->value('location');
                                    ?>
                                        <tr>
                                            <td class="ps-4">{{$department->department}} </td>
                                            <td>{{$emp_name}} </td>
                                            <td>{{$location_name}} </td>
                                            <td class="text-center">
                                                <div class="d-flex justify-content-center gap-2">
                                                    <a href="{{ url('edit-organization-departments/' . $department->id) }}"
                                                    ...
                                                    <a href="{{ url('delete-organization-departments/' . $department->id) }}"
