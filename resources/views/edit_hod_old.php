        ...
        <div class="container-fluid">
            <div class="row clearfix">
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane fade in active show" id="genaral">
                                    ...
                                    <form method="POST" action="{{ url('edit-hod-basic/'.$id) }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row clearfix  mt-4">
                                ...
                                <form method="POST" action="{{ url('change-hod-image/'.$id) }}" enctype="multipart/form-data">
                                 @csrf
                                <div class="row clearfix  mt-4">
                                <div class="col-sm-4">
