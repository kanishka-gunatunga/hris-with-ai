...
foreach ($warning_details as $warning_detail) {
    $company = $warning_detail->company;
    $employee = $warning_detail->employee;
    $warning_type = $warning_detail->warning_type;
    $subject = $warning_detail->subject;
    $warning_date = $warning_detail->warning_date;
    $discription = $warning_detail->discription;
    $status = $warning_detail->status;
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="mb-sm-0 dashboard-title">Edit Warning</h4>
                ...
                <div class="col-xxl-12">
                    <form action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <div class="custom-select">
                                                    ...
                                                    <input type="hidden" name="warning_type"
                                                        value="{{ $warning_type }}">
                                                </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <div class="position-relative">
                                                    <input name="warning_date" value="{{ $warning_date }}" type="text"
                        ...
                        <div class="fixed-bottom bg-white border-top p-3 d-flex justify-content-between align-items-center"
                            ...
                            <button type="submit" class="btn btn-theme-orange px-5 py-2">Save Warning</button>
                        </div>
                    </form>
                </div> <!-- end col -->
            </div>
