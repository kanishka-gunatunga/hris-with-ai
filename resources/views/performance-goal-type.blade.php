            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="mb-sm-0 dashboard-title">Goal Types</h4>
                ...
                <div class="col-lg-12">
                    <div class="card card-theme shadow-none rounded-3 border-0">
                        <div
                            ...
                            <h5 class="card-title mb-0 dashboard-title">Goal Types</h5>
                            <link href="https://fonts.googleapis.com/css2?family=Roboto:wght@400;700&display=swap"
                                rel="stylesheet">
                            <a href="{{url('add-goal-type')}}" class="btn btn-theme-orange">Add Goal Type</a>
                        </div>
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="konnect-table-wrapper table-responsive">
                                <table id="buttons-datatables" class="display table konnect-table mb-0"
                                    ...
                                    <tbody>
                                        <?php foreach ($goal_types as $goal_type) { ?>
                                        <tr class="odd gradeX">
                                            <form action="{{ url('edit-performance-goal-type/' . $goal_type->id) }}"
                                                method="post">
                                                @csrf
                                                <td class="ps-4"> <input type="text" class="form-control"
                                                        name="goal_type" value="{{$goal_type->goal_type}}" required>
                                                </td>
                                            ...
                                            <a href="{{ url('delete-performance-goal-type/' . $goal_type->id) }}"
