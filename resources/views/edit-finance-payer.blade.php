...
foreach ($payer_details as $payer_detail) {
    ...
    $name = $payer_detail->name;
    $nic = $payer_detail->nic;
    $email = $payer_detail->email;
    $telephone = $payer_detail->telephone;
    $address = $payer_detail->address;
    $company_name = $payer_detail->company_name;
    $discription = $payer_detail->discription;
}
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="mb-sm-0 dashboard-title">Edit Payer</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Dashboard</a></li>
                                <li class="breadcrumb-item active">Edit Payer</li>
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card card-theme shadow-none rounded-3 border-0">
                            <div class="card-header border-0 bg-white p-4">
                                <h4 class="card-title mb-0 dashboard-title">Payer Details</h4>
                            </div>
                        ...
                        <div class="fixed-bottom bg-white border-top p-3 d-flex justify-content-between align-items-center"
                            ...
                            <button type="submit" class="btn btn-theme-orange px-5 py-2">Save Payer</button>
                        </div>
                    </form>
                </div> <!-- end col -->
            </div>
