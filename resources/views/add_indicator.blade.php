                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0"style="display: none;">Add Indicator</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Dashboard</a></li>
                                        <li class="breadcrumb-item active">Add Indicator</li>
                                    </ol>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-xxl-12" style="margin:auto;">
                            <div class="card">
                                ...
                                <a href="{{url('performance-indicator')}}"><button type="button" class="btn btn-light">Back</button></a>
                                </div>
