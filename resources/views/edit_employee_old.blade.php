...
foreach ($other_details as $other_detail)  {
    ...
    $company = $other_detail->company;
     $nic = $other_detail->nic;
     $job_description = $other_detail->job_description;
    ...
    $intern_end_date = $other_detail->intern_end_date;
        ...
        <div class="container-fluid">
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                                ...
                                <li role="presentation">
                                    <a href="#accessories" data-bs-toggle="tab">
                                    Accessories
                                    </a>
                                </li>
                            </ul>
                ...
                <div class="row clearfix  mt-4">
                                ...
                                <div class="col-sm-4">
                                <div class="mb-3">
                                <label for="formrow-email-input" class="">Company</label>
                                ...
                                @if($errors->has("company")) <div class="alert alert-danger mt-2">{{ $errors->first('company') }}</li></div>@endif
                                 </div>
                                 <div class="col-sm-4">
                                <div class="mb-3">
                                ...
                                <div class="col-sm-4">
                                <div class="mb-3">
                                <label for="formrow-email-input" class="">Designation</label>
                                <select name="designation" id="designation" style="width:100%" >
                                <option selected value="{{$designation}}"><?php echo Designations::where('id', $designation)->value('designation'); ?></option>
                                <?php
                                ...
                                @if($errors->has("designation")) <div class="alert alert-danger mt-2">{{ $errors->first('designation') }}</li></div>@endif
                                 ...
                                 <div class="col-sm-4">
                                <div class="mb-3">
                                <label for="formrow-email-input" class="">Office Shift</label>
                                <select name="office_shift" id="office_shift" style="width:100%" >

                                <option selected value="{{$office_shift}}">{{$office_shift}}</option>
                                ...
                                @if($errors->has("office_shift")) <div class="alert alert-danger mt-2">{{ $errors->first('office_shift') }}</li></div>@endif
                                 </div>
                                <div class="col-sm-4">
                                <div class="mb-3">
                                ...
                                <label class="form-label">Date of Joining</label>
                                        <div class="form-line">
                                            <input id="myDatePicker" name="join_date" class="flatPicker flatpickr-input active" placeholder="Date of Joining" type="text" value="{{ $join_date }}">
                                        </div>
                                    </div>
                                    @if($errors->has("join_date")) <div class="alert alert-danger mt-2">{{ $errors->first('join_date') }}</li></div>@endif
                                </div>
                                 <div class="col-sm-4">
                                <div class="form-group" id="intern_field">
                                <label class="form-label">Internship End Date</label>
                                        <div class="form-line">
                                            <input id="myDatePicker" name="intern_end_date" class="flatPicker flatpickr-input active" placeholder="Internship End Date" type="text" value="{{ $intern_end_date }}">
                                        </div>
                                    </div>
                                    @if($errors->has("intern_end_date")) <div class="alert alert-danger mt-2">{{ $errors->first('intern_end_date') }}</li></div>@endif
                                </div>
                                ...
                                ?>
                                 <option value="{{$authoriser->id}}"><?php echo OtherAuthoriserDetails::where('user_id', $authoriser->id)->value('name').' (Authoriser)' ?></option>
                                <?php } ?>
                                </select>
                                </div>
                            ...
                            <div class="col-sm-7 mt-4">
                                <div class="file-field input-field">
                                            ...
                                            <div class="file-path-wrapper">
                                                ...
                                                <a href="{{ asset('job_descriptions/'.$job_description.'') }}" download>Download Current Job Description</a>
                                            </div>
                                        </div>
                                </div>
                                 <div class="col-sm-12">
                 ...
                 @csrf
                    ...
                    <div class="col-sm-4">
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="leave">
                                   <form method="POST" action="{{ url('update-custom-leaves') }}" enctype="multipart/form-data">
                                    @csrf
                                <div class="row clearfix  mt-4">

                                <div class="col-sm-12">
                                   <?php foreach($custom_leaves as $custom_leave){
                                       $leave_type =LeaveTypes::where('id', $custom_leave->leave_type)->value('leave_type');
                                   ?>
                                <div class="row">
                                    <div class="col-sm-2">
                                        <p>{{$leave_type}} Leaves</p>
                                    </div>
                                   <div class="col-sm-4">
                                        <input type="hidden" name="leave_id[]" value="{{$custom_leave->id}}">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" class="form-control" name="leave_count[]" value="{{$custom_leave->leave_count}}">
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <div class="table-responsive">
                               ...
                               <form method="POST" action="{{ url('employee-add-accessory/'.$id) }}" enctype="multipart/form-data">
                                @csrf
                                <div class="row clearfix  mt-4">
                                ...
                                <div class="col-sm-4">
                                <div class="mb-3">
                                <label for="formrow-email-input" class="">Select Accessory</label>
                                <select name="accessory" id="accessory" style="width:100%" >
                                <option  value=""></option>

                                <?php
                                foreach($accessories as $accessory){
                                ?>
                                 <option value="{{$accessory->id}}">{{$accessory->accessory_name}}</option>
                                <?php } ?>
                                 </select>

                                </div>
                                @if($errors->has("accessory")) <div class="alert alert-danger mt-2">{{ $errors->first('accessory') }}</li></div>@endif
                                 </div>
                                </div>
                                ...
                                <table class="table table-hover js-basic-example contact_list">
                                    <thead>
                                        <tr>
                                            <th class="center">Accessory</th>
                                            <th class="center">Date</th>
                                            <th class="center">Action</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    <?php foreach($employee_accessories as $employee_accessory){
                                        $accessory_name = Accessories::where('id', $employee_accessory->accessory)->value('accessory_name');
                                   ?>
                                        <tr class="odd gradeX">
                                            <td class="">{{$accessory_name}} </td>
                                            <td class="">{{$employee_accessory->added_date}} </td>
                                            <td>
                                                <a href="{{ url('delete-employee-accessory/'.$employee_accessory->id) }}">
                                                <button type="button" class="btn btn-danger btn-circle waves-effect waves-circle waves-float">
                                                <i class="material-icons">delete_forever</i>
                                                </button>
                                                </a>
