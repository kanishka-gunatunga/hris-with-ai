            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="mb-sm-0 dashboard-title">Official Documents</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Dashboard</a></li>
                                <li class="breadcrumb-item active">Official Documents</li>
                            </ol>
                        </div>
                ...
                <div class="col-lg-12">
                    <div class="card card-theme shadow-none rounded-3 border-0">
                        <div
                            ...
                            <h5 class="card-title mb-0 dashboard-title">Official Documents</h5>
                            <a href="{{url('add-official-document')}}" class="btn btn-theme-orange">Add Official
                                Document</a>
                        </div>
                                ...
                                <table id="buttons-datatables" class="display table konnect-table mb-0"
                                   ...
                                   ?>
                                        <tr>
                                            ...
                                            <td class="ps-4">{{$doc->title}} </td>
                                            <td>{{$doc->document_type}}</td>
                                            <td>{{$doc->expired_date}}</td>
                                            <td>{{$doc->notification}}</td>
                                            <td><a href="{{ asset('file_manager_docs/' . $doc->document . '') }}"
                                                    download>Download</a>
                                            </td>
                                            <td class="text-center">
                                                <div class="d-flex justify-content-center gap-2">
                                                    <a href="{{ url('edit-file-oficial-documents/' . $doc->id) }}"
                                                    ...
                                                    <a href="{{ url('delete-file-oficial-documents/' . $doc->id) }}"
