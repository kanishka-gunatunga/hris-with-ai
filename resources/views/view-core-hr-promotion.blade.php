...
foreach ($promotion_details as $promotion_detail)  {
    $employee =$promotion_detail->employee;
    $title =$promotion_detail->title;
    $promotion_date =$promotion_detail->promotion_date;
    $discription =$promotion_detail->discription;
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0" style="display: none;">View Promotion</h4>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0" style="font-size: 24px; color: rgb(7, 7, 7); font-weight: 500; margin-left: 20px;">View Promotion</h5>
