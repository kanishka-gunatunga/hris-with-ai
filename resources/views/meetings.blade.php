...
<div class="main-content">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="mb-sm-0 dashboard-title">Meetings</h4>
                ...
                <div class="col-lg-12">
                    <div class="card card-theme shadow-none rounded-3 border-0">
                        <div
                            ...
                            <h5 class="card-title mb-0 dashboard-title">Meetings List</h5>
                            <a href="{{url('add-meeting')}}" class="btn btn-theme-orange">Add Meetings</a>
                        </div>
    ...
    $employee = OtherEmployeeDetails::where('user_id', $meeting->employee)->first();
    $employee_name = $employee ? $employee->first_name . ' ' . $employee->last_name : 'N/A';
                                        ?>
                                        <tr>
                                            <td class="ps-4">{{$meeting->meeting_title}} </td>
                                            <td>{{$employee_name}} </td>
                                            <td>{{$meeting->meeting_date}} </td>
                                            <td>{{$meeting->meeting_time}} </td>
                                            <td class="text-center">
                                                <div class="d-flex justify-content-center gap-2">
                                                    <a href="{{ url('edit-meetings/' . $meeting->id) }}"
                                                    ...
                                                    <a href="{{ url('delete-meetings/' . $meeting->id) }}"
