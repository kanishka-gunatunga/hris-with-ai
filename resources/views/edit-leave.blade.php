...
foreach ($leave_details as $leave_detail)  {
    ...
    $department =$leave_detail->department;
    $employee =$leave_detail->employee;
    $leave_duration =$leave_detail->leave_duration;
    $start_date =$leave_detail->start_date;
    $end_date =$leave_detail->end_date;
    $morining_or_evening =$leave_detail->morining_or_evening;
    $date =$leave_detail->date;
    $discription =$leave_detail->discription;
    ...
    if($leave_detail->leave_type == "special"){
        $leave_type_name = "special";
    }
    else{
        $leave_type_name = LeaveTypes::where('id', $leave_detail->leave_type)->value('leave_type');
    }
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="mb-sm-0 dashboard-title">Edit Leave</h4>
                ...
                <div class="col-xxl-12">
                    <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card-body p-4 pt-0" style="overflow: visible !important; padding-bottom: 300px !important;">
                                ...
                                <div class="live-preview">
                                    <div class="row">
                                                ...
                                                <div class="custom-select">
                                                    ...
                                                    <ul class="select-dropdown hidden">
                                                        @foreach ($departments as $dept)
                                                            <?php $ln = OrganizationLocations::where('id', $dept->location)->value('location'); ?>
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <div class="custom-select" id="leave_duration_container">
                                                    ...
                                                    <input type="hidden" name="leave_duration" id="leave_duration" value="{{ $leave_duration }}">
                                                </div>
                                        ...
                                        <div class="col-md-8">
                                            <div class="row" id="full_day_details" @if($leave_duration == 'Half Day') style="display: none;" @endif>
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                            ...
                                            <div class="row" id="half_day_details" @if($leave_duration == 'Full Day') style="display: none;" @endif>
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="custom-select">
                                                            ...
                                                            <input type="hidden" name="morining_or_evening" value="{{ $morining_or_evening ?: 'Morning' }}">
                                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control" name="discription" rows="3">{{ $discription }}</textarea>
                        ...
                        <div class="fixed-bottom bg-white border-top p-3 d-flex justify-content-between align-items-center" style="z-index: 1001; margin-left: 250px;">
                            ...
                            <button type="submit" class="btn btn-theme-orange px-5 py-2">Update Leave</button>
                        </div>
