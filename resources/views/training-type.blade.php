            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="mb-sm-0 dashboard-title">Training Types</h4>
                ...
                <div class="col-lg-12">
                    <div class="card-theme">
                        <div class="card-header d-flex align-items-center justify-content-between">
                            ...
                            <a href="{{url('add-training-type')}}" class="btn btn-theme-orange">Add Training Types</a>
                        </div>
                            ...
                            <div class="konnect-table-wrapper">
                                <table id="buttons-datatables" class="display table konnect-table mb-0" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <form action="{{ url('edit-training-type/' . $training_type->id) }}"
                                                method="post">
                                                @csrf
                                                <td class="ps-4"> <input type="text" class="form-control"
                                                        name="training_type" value="{{$training_type->training_type}}"
                                                        required></td>
                                                <td class="text-center">
                                                    <div class="d-flex justify-content-center gap-2">
                                                        <button type="submit" class="btn-icon-soft-blue" title="Save"
                                            ...
                                            <a href="{{ url('delete-training-type/' . $training_type->id) }}"
