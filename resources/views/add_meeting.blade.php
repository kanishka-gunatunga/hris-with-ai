            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="mb-sm-0 dashboard-title">Add Meeting</h4>
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card card-theme shadow-none rounded-3 border-0"
                            ...
                            <div class="card-header border-0 bg-white p-4">
                                <h4 class="card-title mb-0 dashboard-title">Add Meeting</h4>
                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <div class="position-relative">
                                                    <input name="meeting_date" value="{{ old('meeting_date') }}"
                                                ...
                                                <div class="custom-select">
                                                    <button type="button" class="select-button">
                                                        <span class="selected-value">
                                                            @if(old('employee'))
                                                                <?php    $emp = OtherEmployeeDetails::where('user_id', old('employee'))->first(); ?>
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <div class="custom-select">
                                                    <button type="button" class="select-button">
                                                        <span
                                                            class="selected-value">{{ old('status') ?? 'Select Status' }}</span>
                                                        <span class="arrow"><i class="ri-arrow-down-s-line"></i></span>
                                                    </button>
                                                    <ul class="select-dropdown hidden">
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control" name="meeting_note" rows="3"
                                                    placeholder="Enter additional notes">{{ old('meeting_note') }}</textarea>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-check mb-3">
                                                <input class="form-check-input orange-check" type="checkbox" id="sendNotification" name="send_notification">
