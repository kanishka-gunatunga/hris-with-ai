            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="mb-sm-0 dashboard-title">Add Transfer</h4>
                ...
                <div class="col-xxl-12">
                    <form action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <div class="custom-select">
                                                    <button type="button" class="select-button">
                                                        <span class="selected-value">
                                                            @if (old('from_department'))
                                                                <?php    echo OrganizationDepartments::where('id', old('from_department'))->value('department'); ?>
                                                            @else
                                                    ...
                                                    <ul class="select-dropdown hidden">
                                                        @foreach ($depatments as $depatment)
                                                            <?php    $location_name = OrganizationLocations::where('id', $depatment->location)->value('location'); ?>
                                                            <li data-value="{{ $depatment->id }}">
                                                                {{ $depatment->department . ' (' . $location_name . ')' }}
                                                            </li>
                                                        @endforeach
                                                    </ul>
                                                    <input type="hidden" name="from_department"
                                                        value="{{ old('from_department') }}">
                                                </div>
                                                    ...
                                                    <button type="button" class="select-button">
                                                        <span class="selected-value">
                                                            @if (old('to_department'))
                                                                <?php    echo OrganizationDepartments::where('id', old('to_department'))->value('department'); ?>
                                                            @else
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <div class="position-relative">
                                                    <input name="transfer_date" value="{{ old('transfer_date') }}"
                        ...
                        <div class="fixed-bottom bg-white border-top p-3 d-flex justify-content-between align-items-center"
                            ...
                            <button type="submit" class="btn btn-theme-orange px-5 py-2">Save as Transfer</button>
                        </div>
