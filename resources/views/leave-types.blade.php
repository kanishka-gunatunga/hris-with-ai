            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="mb-sm-0 dashboard-title">Leave Types</h4>
                ...
                <div class="col-lg-12">
                    <div class="card card-theme shadow-none rounded-3 border-0">
                        <div
                            ...
                            <h5 class="card-title mb-0 dashboard-title">Leave Types</h5>
                            <a href="{{url('add-leave-type')}}" class="btn btn-theme-orange">Add Leave Type</a>
                        </div>
                                ...
                                <table id="buttons-datatables" class="display table konnect-table mb-0"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$leave_type->leave_available}} </td>
                                            <td>{{$leave_type->leave_count}} </td>
                                            <td class="text-center">
                                                <div class="d-flex justify-content-center gap-2">
                                                    <a href="{{ url('edit-leave-type/' . $leave_type->id) }}"
                                                    ...
                                                    <a href="{{ url('delete-leave-type/' . $leave_type->id) }}"
