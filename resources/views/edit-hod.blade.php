...
<style>
    ...
    /* Custom Dropdown Styling Override if needed */
    .custom-select {
        position: relative;
        width: 100%;
    }
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="mb-sm-0 dashboard-title">Edit HOD</h4>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title mb-0">Edit HOD</h5>
                                                                        ...
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <div class="custom-select"
                                                                                ...
                                                                                <ul class="select-dropdown hidden"
                                                                                    ...
                                                                                    <?php
foreach ($departments as $dept_item) {
    $location_name = OrganizationLocations::where('id', $dept_item->location)->value('location');
                                                                    ?>
                                                                                    <li role="option"
                                                                                        data-value="{{$dept_item->id}}">
                                                                                        {{$dept_item->department . ' (' . $location_name . ')'}}
                                                                                    </li>
                                                                                    <?php } ?>
                                                                                </ul>
                                                                        ...
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <div class="date-picker-wrapper">
                                                                                <input type="text"
                                                                                    ...
                                                                                    data-date-format="n/j/Y" name="dob"
                                                                                    value="{{ $dob }}">
                                                                                <i
                                                                                    class="ri-calendar-line calendar-icon"></i>
                                                                            </div>
                                                                            @if($errors->has("dob"))
                                                                                <div class="alert alert-danger mt-2">
                                                                                    {{ $errors->first('dob') }}
                                                                        ...
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <div class="custom-select"
                                                                                ...
                                                                                <button type="button"
                                                                                    ...
                                                                                    aria-haspopup="listbox"
                                                                                    aria-expanded="false"
                                                                                    aria-controls="gender-dropdown">
                                                                                    <span
                                                                                        class="selected-value">{{$gender}}</span>
                                                                                    <span class="arrow"></span>
                                                                                </button>
                                                                                <ul class="select-dropdown hidden"
                                                                                    role="listbox" id="gender-dropdown">
                                                                                    <li role="option"
                                                                                        data-value="{{$gender}}"
                                                                                        class="selected">
                                                                                        {{$gender}}
                                                                                    </li>
                                                                                    <li role="option" data-value="Male">
                                                                                        Male</li>
                                                                                    <li role="option"
                                                                                        data-value="Female">Female</li>
                                                                                </ul>
                                                                        ...
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <div class="custom-select"
                                                                                ...
                                                                                <button type="button"
                                                                                    ...
                                                                                    aria-haspopup="listbox"
                                                                                    aria-expanded="false"
                                                                                    aria-controls="employment-type-dropdown">
                                                                                    <span
                                                                                        class="selected-value">{{$employment_type}}</span>
                                                                                    <span class="arrow"></span>
                                                                                </button>
                                                                                <ul class="select-dropdown hidden"
                                                                                    role="listbox"
                                                                                    ...
                                                                                    <li role="option"
                                                                                        data-value="Full Time">Full Time
                                                                                    </li>
                                                                                    <li role="option"
                                                                                        data-value="Part Time">Part Time
                                                                                    </li>
                                                                                    <li role="option"
                                                                                        data-value="Intern">Intern</li>
                                                                                </ul>
                                                                                <input type="hidden"
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="mb-3">
                                                                            <label for="responsible_person"
                                                                                ...
                                                                                Person</label>
                                                                            <div class="custom-select"
                                                                                id="responsible-person-select">
                                                                                <button type="button"
                                                                                    class="select-button"
                                                                                    role="combobox"
                                                                                    aria-labelledby="responsible-person-label"
                                                                                    aria-haspopup="listbox"
                                                                                    aria-expanded="false"
                                                                                    aria-controls="responsible-person-dropdown">
                                                                                    <span
                                                                                        class="selected-value">{{$responsible_person_name}}</span>
                                                                                    <span class="arrow"></span>
                                                                                </button>
                                                                                <ul class="select-dropdown hidden"
                                                                                    role="listbox"
                                                                                    id="responsible-person-dropdown">
                                                                                    <li role="option"
                                                                                        data-value="{{$responsible_person}}"
                                                                                        class="selected">
                                                                                        {{$responsible_person_name}}
                                                                                    </li>
                                                        ...
                                                        <div class="tab-pane fade" id="subtab2" role="tabpanel"
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-12">
                                                                    <button type="button" class="mt-4 btn btn-info mb-4"
                                                                    ...
                                                                    <table id="buttons-datatables"
                                                                        class="display table table-bordered table-theme"
                                                                        style="width:100%">
                                                                        <thead>
                                                                            <tr>
        ...
        $whatsapp_profile = $social_pro->whatsapp_profile;
                ...
                ?>
                                    ...
                                    <div class="tab-pane" id="tab2" role="tabpanel">
                                        ...
                                        <form method="POST" action="{{ url('change-hod-image/' . $id) }}"
                                            enctype="multipart/form-data">
                                            @csrf
...
if ($pansion_type == null) { ?>
                                    ...
                                    <div class="tab-pane" id="tab4" role="tabpanel">
                                        <table id="buttons-datatables" class="display table table-bordered table-theme"
                                            style="width:100%">
                                            <thead>
                                                <tr>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            // Initialize Custom Dropdowns (if any specific logic needed)
