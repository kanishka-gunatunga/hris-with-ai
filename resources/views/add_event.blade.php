...
<div class="main-content">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="mb-sm-0 dashboard-title">Add Event</h4>
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card card-theme shadow-none rounded-3 border-0"
                            ...
                            <div class="card-header border-0 bg-white p-4">
                                <h4 class="card-title mb-0 dashboard-title">Add Event</h4>
                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="event_title"
                                                    value="{{ old('event_title') }}" placeholder="Enter event title">
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <div class="position-relative">
                                                    <input name="event_date" value="{{ old('event_date') }}" type="text"
    ...
    $location_name = OrganizationLocations::where('id', $department->location)->value('location');
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control" name="event_note" rows="3"
                                                    placeholder="Enter additional notes">{{ old('event_note') }}</textarea>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-check form-switch mb-3">
                                                <input class="form-check-input" type="checkbox" id="notificationSwitch"
                                                    name="notification" {{ old('notification') ? 'checked' : '' }}>
                        ...
                        <div class="fixed-bottom bg-white border-top p-3 d-flex justify-content-between align-items-center"
                            ...
                            <button type="submit" class="btn btn-theme-orange px-5 py-2">Save as Event</button>
                        </div>
                    </form>
                </div> <!-- end col -->
            </div>
