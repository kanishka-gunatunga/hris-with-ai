...
<div class="main-content">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="mb-sm-0 dashboard-title">File Manager</h4>
                ...
                <div class="col-lg-12">
                    <div class="card card-theme shadow-none rounded-3 border-0">
                        <div
                            ...
                            <h5 class="card-title mb-0 dashboard-title">File Manager</h5>
                            <a href="{{url('add-file')}}" class="btn btn-theme-orange">Add File</a>
                        </div>
    ...
    $dep_name = OrganizationDepartments::where('id', $file->department)->value('department');
                                   ?>
                                        <tr>

                                            <td class="ps-4">{{$file->file_name}} </td>
                                            <td>{{$dep_name}} </td>
                                            <td><a href="{{ asset('file_manager_docs/' . $file->document . '') }}"
                                                    download>Download</a>
                                            </td>
                                            <td class="text-center">
                                                <div class="d-flex justify-content-center gap-2">
                                                    <a href="{{ url('edit-file-manager/' . $file->id) }}"
                                                    ...
                                                    <a href="{{ url('delete-file-manager/' . $file->id) }}"
