                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="custom-select">
                                                    <button type="button" class="select-button">
                                                        <span class="selected-value">
                                                            @if (old('leave_type'))
                                                                @if(old('leave_type') == 'special') Special @else
                                                                    <?php        echo LeaveTypes::where('id', old('leave_type'))->value('leave_type'); ?>
                                                                @endif
                                                            @else
                                                                Select Leave Type
                                                            @endif
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <div class="custom-select" id="leave_duration_container">
                                                    ...
                                                    <input type="hidden" name="leave_duration" id="leave_duration"
                                                        value="{{ old('leave_duration', 'Full Day') }}">
                                                </div>
                                                @if ($errors->has('leave_duration'))
                                                    <div class="alert alert-danger mt-2">
                                                        {{ $errors->first('leave_duration') }}
                                                    </div>
                                                @endif
                                            </div>
                                        </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="custom-select">
                                                            ...
                                                            <input type="hidden" name="morining_or_evening"
                                                                value="{{ old('morining_or_evening', 'Morning') }}">
                                                        </div>
                                                        @if ($errors->has('morining_or_evening'))
                                                            <div class="alert alert-danger mt-2">
                                                                {{ $errors->first('morining_or_evening') }}
                                                            </div>
                                                        @endif
                                                    </div>
                                                </div>
                        ...
                        <div class="fixed-bottom bg-white border-top p-3 d-flex justify-content-between align-items-center"
                            ...
                            <button type="button" class="btn btn-outline-secondary px-4 py-2 action-btn-back"
                                ...
                                onclick="window.location.href='{{ url('employee-leaves/' . Auth::user()->id) }}'">Back</button>
