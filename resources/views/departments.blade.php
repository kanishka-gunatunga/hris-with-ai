            ...
            <div class="row clearfix">
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                    <div class="card">
                        ...
                        <div class="body">
            <form method="POST" action="{{ url('add-department') }}" enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-hover js-basic-example contact_list">
                                    ...
                                    ?>
                                        <tr class="odd gradeX">
                                        <form action="{{ url('edit-department/'.$department->id) }}" method="post">
                                            @csrf
                                            <td class=""> <input type="text" class="form-control" name="department" value="{{$department->department}}" required></td>
                                            <td class="">
                                            <?php 
