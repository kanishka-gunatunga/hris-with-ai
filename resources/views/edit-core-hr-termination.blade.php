...
foreach ($termination_details as $termination_detail) {
    $employee = $termination_detail->employee;
    $termination_type = $termination_detail->termination_type;
    $termination_date = $termination_detail->termination_date;
    $notice_date = $termination_detail->notice_date;
    $discription = $termination_detail->discription;
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="mb-sm-0 dashboard-title">Edit Termination</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Dashboard</a></li>
                                <li class="breadcrumb-item active">Edit Termination</li>
                            </ol>
                        </div>
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card card-theme shadow-none rounded-3 border-0"
                            ...
                            <div class="card-header border-0 bg-white p-4">
                                <h4 class="card-title mb-0 dashboard-title">Termination Details</h4>
                            </div>
                            ...
                            <div class="card-body p-4 pt-0" style="overflow: visible !important; min-height: 350px;">
                                ...
                                <div class="live-preview">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <label class="form-label text-[#556476] font-medium">Termination
                                                    Type</label>
                                                <div class="custom-select">
                                                    <button type="button" class="select-button">
                                                        <span class="selected-value">
                                                    ...
                                                    <input type="hidden" name="termination_type"
                                                        value="{{ $termination_type }}">
                                                </div>
                                                @if ($errors->has('termination_type'))
                                                    <div class="alert alert-danger mt-2">
                                                        {{ $errors->first('termination_type') }}
                                                    </div>
                                                @endif
                                            </div>
                                        </div>
                        ...
                        <div class="fixed-bottom bg-white border-top p-3 d-flex justify-content-between align-items-center"
                            ...
                            <button type="button" class="btn btn-outline-secondary px-4 py-2 action-btn-back"
                                ...
                                onclick="window.location.href='{{ url('core-hr-terminations') }}'">Back</button>
                            <button type="submit" class="btn btn-theme-orange px-5 py-2">Save Termination</button>
                        </div>
                    </form>
                </div> <!-- end col -->
            </div>
