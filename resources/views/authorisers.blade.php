...
<div class="main-content">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="mb-sm-0 dashboard-title">Authorizers</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Dashboard</a></li>
                                <li class="breadcrumb-item active">Authorizers</li>
                            </ol>
                        </div>
                ...
                <div class="col-lg-12">
                    <div class="card card-theme shadow-none rounded-3 border-0">
                        <div
                            ...
                            <h5 class="card-title mb-0 dashboard-title">Authorizers List</h5>
                            <link href="https://fonts.googleapis.com/css2?family=Roboto:wght@400;700&display=swap"
                                rel="stylesheet">
                            <a href="{{url('add-authoriser')}}" class="btn btn-theme-orange">Add Authorizer</a>
                        </div>
    ...
    $image = OtherAuthoriserDetails::where('user_id', $authoriser->id)->value('image');
    $name = OtherAuthoriserDetails::where('user_id', $authoriser->id)->value('name');
    $phone = OtherAuthoriserDetails::where('user_id', $authoriser->id)->value('phone');
                                ?>
                                        <tr>
                                            <td class="ps-4">
                                            ...
                                            <td>
                                                <?php    if ($authoriser->status == "active") { ?>
                                            ...
                                            <td class="text-center">
                                                <div class="d-flex justify-content-center gap-2">
                                                    <a href="{{ url('edit-authoriser/' . $authoriser->id) }}"
                                                    ...
                                                    <a href="{{ url('deactivate-authoriser/' . $authoriser->id) }}"
                                                    ...
                                                    <a href="{{ url('activate-authoriser/' . $authoriser->id) }}"
