            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="mb-sm-0 dashboard-title">Add Deposit</h4>
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card card-theme shadow-none rounded-3 border-0">
                            <div class="card-header border-0 bg-white p-4">
                                <h4 class="card-title mb-0 dashboard-title">Add Deposit</h4>
                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <div class="custom-select">
                                                    <button type="button" class="select-button">
                                                        <span class="selected-value">Select Payer</span>
                                                        <span class="arrow">
                                                            <i class="ri-arrow-down-s-line"></i>
                                                        </span>
                                                    </button>
                                                    <ul class="select-dropdown hidden">
                                                        ...
                                                        <li data-value="{{ $payer->id }}">{{ $payer->name }}
                                                        </li>
                                                        <?php } ?>
                                                    </ul>
                                                    <input type="hidden" name="payer" value="{{ old('payer') }}">
                                                </div>
                                                @if ($errors->has('payer'))
                                                    <div class="alert alert-danger mt-2">{{ $errors->first('payer') }}
                                                    </div>
                                                @endif
                                            </div>
                                        </div>
                        ...
                        <div class="fixed-bottom bg-white border-top p-3 d-flex justify-content-between align-items-center"
                            ...
                            <button type="button" class="btn btn-outline-secondary px-4 py-2 action-btn-back"
                                ...
                                onclick="window.location.href='{{ url('finance-deposit') }}'">Back</button>
