...
foreach ($meeting_details as $meeting_detail) {
    $meeting_title = $meeting_detail->meeting_title;
    $meeting_date = $meeting_detail->meeting_date;
    $meeting_time = $meeting_detail->meeting_time;
    $status = $meeting_detail->status;
    $meeting_note = $meeting_detail->meeting_note;
    $employee_id = $meeting_detail->employee;
}
?>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="mb-sm-0 dashboard-title">Edit Meeting</h4>
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card card-theme shadow-none rounded-3 border-0"
                            ...
                            <div class="card-header border-0 bg-white p-4">
                                <h4 class="card-title mb-0 dashboard-title">Edit Meeting</h4>
                            </div>
                            ...
                            <div class="card-body p-4 pt-0" style="overflow: visible !important; min-height: 400px;">
                                ...
                                <div class="live-preview">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <label class="form-label text-[#556476] font-medium">Meeting
                                                    Title</label>
                                                <input type="text" class="form-control" name="meeting_title"
                                                    value="{{ $meeting_title }}" placeholder="Enter meeting title">
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <div class="position-relative">
                                                    <input name="meeting_date" value="{{ $meeting_date }}" type="text"
                                                        class="form-control flatpickr-input active"
                                                        data-provider="flatpickr" data-date-format="n/j/Y"
                                                        id="meeting_date" placeholder="Select date" readonly="readonly">
                                                    <span
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <label class="form-label text-[#556476] font-medium">Meeting
                                                    Time</label>
                                                <div class="position-relative">
                                                    <input type="text" name="meeting_time" value="{{ $meeting_time }}"
                                                ...
                                                <div class="custom-select">
                                                    <button type="button" class="select-button">
                                                        <span class="selected-value">
                                                            <?php $emp = OtherEmployeeDetails::where('user_id', $employee_id)->first(); ?>
                                                            {{ $emp ? $emp->first_name . ' ' . $emp->last_name : 'Select Employee' }}
                                                        </span>
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                <label class="form-label text-[#556476] font-medium">Meeting
                                                    Note</label>
                                                <textarea class="form-control" name="meeting_note" rows="3"
                                                    placeholder="Enter additional notes">{{ $meeting_note }}</textarea>
                                                @if($errors->has("meeting_note"))
                                                    <div class="alert alert-danger mt-2">
                                                        {{ $errors->first('meeting_note') }}
                                                    </div>
                                                @endif
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-check mb-3">
                                                <input class="form-check-input orange-check" type="checkbox"
                                                    id="sendNotification" name="send_notification">
                                                <label class="form-check-label text-[#556476]" for="sendNotification">
                                                    Send Notification?
                                                </label>
                                            </div>
                                        </div>
                        ...
                        <div class="fixed-bottom bg-white border-top p-3 d-flex justify-content-between align-items-center"
                            ...
                            <button type="button" class="btn btn-outline-secondary px-4 py-2 action-btn-back"
                                ...
                                onclick="window.location.href='{{url('meetings')}}'">Back</button>
                            <button type="submit" class="btn btn-theme-orange px-5 py-2">Save Meeting</button>
                        </div>
                    </form>
                </div> <!-- end col -->
            </div>
