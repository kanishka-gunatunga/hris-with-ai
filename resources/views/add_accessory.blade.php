            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="mb-sm-0 dashboard-title">Add Accessory</h4>
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card card-theme shadow-none rounded-3 border-0"
                            ...
                            <div class="card-header border-0 bg-white p-4">
                                <h4 class="card-title mb-0 dashboard-title">Add Accessory</h4>
                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="accessory_name"
                                                    class="form-label text-[#556476] font-medium">Accessory Name</label>
                                                <input type="text" class="form-control" name="accessory_name"
                                                    value="{{ old('accessory_name') }}"
                        ...
                        <div class="fixed-bottom bg-white border-top p-3 d-flex justify-content-between align-items-center"
                            ...
                            <button type="button" class="btn btn-outline-secondary px-4 py-2 action-btn-back"
                                ...
                                onclick="window.location.href='{{url('accessories')}}'">Back</button>
                            <button type="submit" class="btn btn-theme-orange px-5 py-2">Save as Accessory</button>
                        </div>
                    </form>
                </div>
            </div>
