...
foreach ($details as $detail)  {
    ...
    $assigned_empoyees = PMProjectsEmployees::where('project_id', $detail->id)->get();

    $client_name = OtherClientDetails::where('user_id', $detail->client)->value('first_name').' '.OtherClientDetails::where('user_id', $detail->client)->value('last_name');
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0" style="display: none;">View Project</h4>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0" style="font-size: 24px; color: rgb(7, 7, 7); font-weight: 500; margin-left: 20px;">View Project</h5>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="col-md-8 view-content">
                        <h2>   <?php foreach($assigned_empoyees as $assigned_empoyee){
