...
foreach ($details as $detail)  {
    $termination_type =$detail->termination_type;
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0" style="display: none;">View Termination</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Dashboard</a></li>
                            <li class="breadcrumb-item active">View Termination</li>
                        </ol>
                    </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0" style="font-size: 24px; color: rgb(7, 7, 7); font-weight: 500; margin-left: 20px;">View Termination</h5>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="col-md-8 view-content">
                        <h2>{{$termination_type}}</h2>
                        </div>
                        <div class="col-md-4 view-header">
                        <h2>Termination Date</h2>
                        </div>
                        <div class="col-md-8 view-content">
                        <h2>{{$termination_date}}</h2>
                        </div>
                        <div class="col-md-4 view-header">
                        <h2>Notice Date</h2>
                        </div>
