...
<div class="main-content">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="mb-sm-0 dashboard-title">Admins</h4>
                ...
                <div class="col-lg-12">
                    <div class="card card-theme shadow-none rounded-3 border-0">
                        <div
                            ...
                            <h5 class="card-title mb-0 dashboard-title">Admins List</h5>
                            <link href="https://fonts.googleapis.com/css2?family=Roboto:wght@400;700&display=swap"
                                rel="stylesheet">
                            <a href="{{url('add-admin')}}" class="btn btn-theme-orange">Add Admin</a>
                        </div>
    ...
    $image = OtherAdminDetails::where('user_id', $admin->id)->value('image');
    $name = OtherAdminDetails::where('user_id', $admin->id)->value('first_name') . ' ' . OtherAdminDetails::where('user_id', $admin->id)->value('last_name');
    $phone = OtherAdminDetails::where('user_id', $admin->id)->value('phone');
                                ?>
                                        <tr>
                                            <td class="ps-4">
                                            ...
                                            <td class="text-center">
                                                <div class="d-flex justify-content-center gap-2">
                                                    ...
                                                    <a href="{{ url('deactivate-admin/' . $admin->id) }}"
                                                    ...
                                                    <a href="{{ url('activate-admin/' . $admin->id) }}"
