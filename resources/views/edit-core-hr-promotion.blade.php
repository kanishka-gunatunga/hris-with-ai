...
foreach ($promotion_details as $promotion_details) {
    $employee = $promotion_details->employee;
    $title = $promotion_details->title;
    $promotion_date = $promotion_details->promotion_date;
    $discription = $promotion_details->discription;
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                <h4 class="mb-sm-0 dashboard-title">Edit Promotion</h4>
                        ...
                        <div class="col-xxl-12" style="margin:auto;">
                            <div class="card card-theme shadow-none rounded-3 border-0" style="overflow: visible !important;">
                                <div class="card-header border-0 bg-white p-4">
                                    <h4 class="card-title mb-0 dashboard-title">Edit Promotion</h4>
                                </div><!-- end card header -->

                                <form  action="" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body p-4 pt-0" style="overflow: visible !important; min-height: 350px;">
                                @if(Session::has('success')) <div class="alert alert-success mt-2 mb-4">{{ Session::get('success') }}</div>@endif
                                    <div class="live-preview">
                                            ...
                                            <div class="col-md-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="custom-select">
                                                            <button type="button" class="select-button">
                                                                <span class="selected-value">{{$employee_name}}</span>
                                                                <span class="arrow"><i class="ri-arrow-down-s-line"></i></span>
                                                            </button>
                                                            <ul class="select-dropdown hidden">
                                                                @foreach($employees as $emp)
                                                                    <li data-value="{{$emp->user_id}}">{{$emp->first_name . ' ' . $emp->last_name}}</li>
                                                                @endforeach
                                                            </ul>
                                                            <input type="hidden" name="employee" value="{{$employee}}">
                                                        </div>
                                                        @if($errors->has("employee")) <div class="alert alert-danger mt-2">{{ $errors->first('employee') }}</div>@endif
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        <label class="form-label text-[#556476] font-medium">Promotion Date</label>
                                                        <div class="position-relative">
                                                            <input name="promotion_date" value="{{ $promotion_date }}" type="text" class="form-control flatpickr-input active" data-provider="flatpickr" data-date-format="n/j/Y" id="promotion_date" readonly="readonly" >
                                                            <span class="position-absolute top-50 end-0 translate-middle-y me-3 text-muted" style="pointer-events: none;">
                                                                <i class="ri-calendar-2-line"></i>
                                                            </span>
                                                        </div>
                                                        @if($errors->has("promotion_date")) <div class="alert alert-danger mt-2">{{ $errors->first('promotion_date') }}</div>@endif
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        ...
                                                        @if($errors->has("discription")) <div class="alert alert-danger mt-2">{{ $errors->first('discription') }}</div>@endif
                                                    </div>
                                                </div>
                                                <!--end col-->
                                ...
                                <div class="fixed-bottom bg-white border-top p-3 d-flex justify-content-between align-items-center"
                                    ...
                                    <button type="button" class="btn btn-outline-secondary px-4 py-2 action-btn-back"
                                        ...
                                        onclick="window.location.href='{{ url('core-hr-promotions') }}'">Back</button>
                                    <button type="submit" class="btn btn-theme-orange px-5 py-2">Save Promotion</button>
                                </div>
                                <style>
                                    .card-theme {
