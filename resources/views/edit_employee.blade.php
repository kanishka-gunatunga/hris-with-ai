            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="mb-sm-0 dashboard-title">Edit Employee</h4>
                ...
                <div class="col-lg-12">
                    <div class="card card-theme shadow-none rounded-3 border-0">
                        <div class="card-header border-0 bg-white p-4">
                            <h5 class="card-title mb-0 dashboard-title">Edit Employee</h5>
                                                ...
                                                <div class="col-lg-10">
                                                    <div class="tab-content text-muted mt-3 mt-lg-0">
                                                        <div class="tab-pane fade active show" id="subtab1"
                                                            ...
                                                            <form method="POST"
                                                                action="{{ url('edit-employee-basic/' . $id) }}"
                                                                ...
                                                                <div class="row">
                                                                        ...
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <div class="custom-select">
                                                                                <button type="button"
                                                                                    class="select-button">
                                                                                    <span
                                                                                        class="selected-value">{{$company ?: 'Select Branch'}}</span>
                                                                                    <span class="arrow"><i
                                                                                            class="ri-arrow-down-s-line"></i></span>
                                                                                </button>
                                                                                <ul class="select-dropdown hidden">
                                                                                    <li data-value="Kegalle">Kegalle
                                                                                    </li>
                                                                                    <li data-value="Avissawella">
                                                                                        Avissawella</li>
                                                                                    <li data-value="Colombo">Colombo
                                                                                    </li>
                                                                                    <li data-value="Rathnapura">
                                                                                        Rathnapura</li>
                                                                                </ul>
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="mb-3">
                                                                            <label for="firstNameinput"
                                                                                class="form-label">Select Gender</label>
                                                                            <div class="custom-select">
                                                                                <button type="button"
                                                                                    class="select-button">
                                                                                    <span
                                                                        ...
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <div class="custom-select">
                                                                                <button type="button"
                                                                                    class="select-button">
                                                                                    <span
                                                                                        class="selected-value">{{ OrganizationDesignations::where('id', $designation)->value('designation') ?: 'Select Designation' }}</span>
                                                                                    <span class="arrow"><i
                                                                                            class="ri-arrow-down-s-line"></i></span>
                                                                                </button>
                                                                                <ul class="select-dropdown hidden">
                                                                                    @foreach($designations as $desig)
                                                                                        <li data-value="{{$desig->id}}">
                                                                                            {{$desig->designation}}
                                                                                        </li>
                                                                                    @endforeach
                                                                                </ul>
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="mb-3">
                                                                            <label for="firstNameinput"
                                                                                class="form-label">Office Shift</label>
                                                                            <div class="custom-select">
                                                                                <button type="button"
                                                                                    class="select-button">
                                                                                    <span
                                                                                        class="selected-value">{{$office_shift ?: 'Select Office Shift'}}</span>
                                                                                    <span class="arrow"><i
                                                                                            class="ri-arrow-down-s-line"></i></span>
                                                                                </button>
                                                                                <ul class="select-dropdown hidden">
                                                                                    <li data-value="Type 1">Type 1</li>
                                                                                    <li data-value="Type 2">Type 2</li>
                                                                                </ul>
                                                                        ...
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <div class="position-relative">
                                                                                <input type="text"
                                                                                    ...
                                                                                    data-provider="flatpickr"
                                                                                    data-date-format="n/j/Y"
                                                                                    readonly="readonly" name="join_date"
                                                                                    value="{{ $join_date }}">
                                                                                <span
                                                                                    class="position-absolute top-50 end-0 translate-middle-y me-3 text-muted"
                                                                                    style="pointer-events: none;">
                                                                    ...
                                                                    <div class="col-md-4" id="intern_field">
                                                                        <div class="mb-3">
                                                                            <label for="firstNameinput"
                                                                                class="form-label">Internship End
                                                                                Date</label>
                                                                            <div class="position-relative">
                                                                                <input type="text"
                                                                                    class="form-control flatpickr-input active"
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="mb-3">
                                                                            <label for="firstNameinput"
                                                                                class="form-label">EPF Number</label>
                                                                            <input type="text" class="form-control"
                                                                                name="epf_no" value="{{ $epf_no }}">
                                                                            @if($errors->has("epf_no"))
                                                                                <div class="alert alert-danger mt-2">
                                                                                    {{ $errors->first('epf_no') }}</li>
                                                                            </div>@endif
                                                                        </div>
                                                                    </div>
                                                                    <!--end col-->
                                                                                ...
                                                                                <ul class="select-dropdown hidden">
                                                                                    @foreach($hods as $hod)
                                                                                        <li data-value="{{$hod->id}}">
                                                                                            {{OtherHODDetails::where('user_id', $hod->id)->value('name') . ' (HOD)'}}
                                                                                        </li>
                                                                                    @endforeach
                                                                                    @foreach($hrms as $hrm)
                                                                                        <li data-value="{{$hrm->id}}">
                                                                                            {{OtherHRManagerDetails::where('user_id', $hrm->id)->value('first_name') . ' ' . OtherHRManagerDetails::where('user_id', $hrm->id)->value('last_name') . ' (HRM)'}}
                                                                                        </li>
                                                                                    @endforeach
                                                                                    @foreach($authorisers as $authoriser)
                                                                                        <li
                                                                                            data-value="{{$authoriser->id}}">
                                                                                            {{OtherAuthoriserDetails::where('user_id', $authoriser->id)->value('name') . ' (Authoriser)'}}
                                                                                        </li>
                                                                                    @endforeach
                                                                                </ul>
                                                                                <input type="hidden"
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <a href="{{ asset('job_descriptions/' . $job_description . '') }}"
                                                                                download>Download Current Job
                                                                                Description</a>
        ...
        $whatsapp_profile = $social_pro->whatsapp_profile;
                ...
                ?>
                                    ...
                                    <div class="tab-pane" id="tab2" role="tabpanel">
                                        ...
                                        <form method="POST" action="{{ url('change-employee-image/' . $id) }}"
                                            enctype="multipart/form-data">
                                            @csrf
                                                                                            ...
                                                                                            <div class="col-md-4">
                                                                                                <div class="mb-3">
                                                                                                    ...
                                                                                                    <select
                                                                                                        ...
                                                                                                        <option
                                                                                                            value="Monthly Payslip">
                                                                                                            Monthly
                                                                                                            Payslip
                                                                                                        </option>
                                                                                                        <option
                                                                                                            value="Hourly Payslip">
                                                                                                            Hourly
                                                                                                            Payslip
                                                                                                        </option>
                                                                                                    </select>
                                                                                            ...
                                                                                            <div class="col-md-4">
                                                                                                <div class="mb-3">
                                                                                                    ...
                                                                                                    <select
                                                                                                        ...
                                                                                                        <option
                                                                                                            value="Social Security System Loan">
                                                                                                            Social
                                                                                                            Security
                                                                                                            System Loan
                                                                                                        </option>
                                                                                                        <option
                                                                                                            value="Home Development Mututal Fund Loan">
                                                                                                            Home
                                                                                                            Development
                                                                                                            Mututal Fund
                                                                                                            Loan
                                                                                            ...
                                                                                            <div class="col-md-4">
                                                                                                <div class="mb-3">
                                                                                                    ...
                                                                                                    <select
                                                                                                        ...
                                                                                                        <option
                                                                                                            value="Health insurance Coparation">
                                                                                                            Health
                                                                                                            insurance
                                                                                                            Coparation
                                                                                                        </option>
                                                                                                        <option
                                                                                                            value="Home Develpment Mutual Funds">
                                                                                                            Home
                                                                                                            Develpment
                                                                                                            Mutual Funds
                                                                                                        </option>
                                                                                                        <option
                                                                                                            value="Withdrowing Tax on Wages">
                                                                                                            Withdrowing
                                                                                                            Tax on Wages
                                                                                                        </option>
                                                                                                        <option
                                                                                                            value="Other Satuary Deductions">
                                                                                                            Other
                                                                                                            Satuary
                                                                                                            Deductions
                                                                                                        </option>
...
if ($pansion_type == null) { ?>
                                            ...
                                            ?>
                                                                                ...
                                                                                <option value="Presentage">Presentage
                                                                                </option>
                                                                            </select>
        ...
        $leave_type_name = LeaveTypes::where('id', $leave->leave_type)->value('leave_type');
                                   ...
                                   ?>
                                    ...
                                    <div class="tab-pane" id="tab5" role="tabpanel">
                                        ...
                                        <form method="POST" action="{{ url('download-pay-slip/' . $id) }}"
                                            enctype="multipart/form-data">
                                            @csrf
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    <label for="yearMonthInput" class="form-label">Year and Month (EG :
                                                        2022-01)</label>
                                                    <input name="year_month" value="{{ old('year_month') }}" type="text"
                                                        class="form-control flatpickr-input active"
                                                        data-provider="flatpickr" data-date-format="Y-m" readonly>
                                            ...
                                            <button type="submit" class="btn btn-theme-orange">Download</button>
                                        </form>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            // Function to toggle intern field visibility
            function toggleInternField(value) {
                if (value === "Intern") {
                    document.getElementById("intern_field").style.display = "block";
                } else {
                    document.getElementById("intern_field").style.display = "none";
                }
            }
            ...
            if (employmentTypeInput) {
                toggleInternField(employmentTypeInput.value);

                // Listen for changes
                employmentTypeInput.addEventListener("change", function () {
                    toggleInternField(this.value);
                });
            }
