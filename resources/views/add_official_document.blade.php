            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="mb-sm-0 dashboard-title">Add Official Document</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Dashboard</a></li>
                                <li class="breadcrumb-item active">Add Official Document</li>
                            </ol>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="live-preview">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <div class="position-relative">
                                                    <input name="expired_date" value="{{ old('expired_date') }}"
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <label for="document"
                                                    class="form-label text-[#556476] font-medium">Document File</label>
