...
<div class="main-content">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="mb-sm-0 dashboard-title">Resignations</h4>
                ...
                <div class="col-lg-12">
                    <div class="card card-theme shadow-none rounded-3 border-0">
                        <div
                            ...
                            <h5 class="card-title mb-0 dashboard-title">Resignations List</h5>
                            <link href="https://fonts.googleapis.com/css2?family=Roboto:wght@400;700&display=swap"
                                rel="stylesheet">
                            <a href="{{url('add-resignation')}}" class="btn btn-theme-orange">Add Resignation</a>
                        </div>
    ...
    $emp_name = OtherEmployeeDetails::where('user_id', $resignation->employee)->value('first_name') . ' ' . OtherEmployeeDetails::where('user_id', $resignation->employee)->value('last_name');
    $department_name = OrganizationDepartments::where('id', $resignation->department)->value('department');
    $department_location = OrganizationDepartments::where('id', $resignation->department)->value('location');
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="d-flex justify-content-center gap-2">
                                                    <a href="{{ url('edit-core-hr-resignation/' . $resignation->id) }}"
                                                    ...
                                                    <a href="{{ url('delete-core-hr-resignation/' . $resignation->id) }}"
