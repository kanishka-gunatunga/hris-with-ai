<!-- <footer class="footer">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-6">
                            <script>document.write(new Date().getFullYear())</script> © KO2labs.
                        </div>
                        <div class="col-sm-6">
                            <div class="text-sm-end d-none d-sm-block">
                                Design & Develop by KO2 Labs
                            </div>
                        </div>
                    </div>
                </div>
...
<!-- Legacy Footer Content (Scripts etc) -->
                    ...
                    <div class="d-flex gap-2 flex-wrap img-switch">
                        ...
                        <div class="form-check sidebar-setting card-radio">
                            ...
                            <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-01">
                                <img src="{{ asset('assets/js/layout.js') }}images/sidebar/img-1.jpg" alt=""
...
<!-- Mirrored from themesbrand.com/velzon/html/material/dashboard-crm.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 Mar 2023 03:58:23 GMT -->
