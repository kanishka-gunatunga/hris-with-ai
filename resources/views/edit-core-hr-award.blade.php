            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="mb-sm-0 dashboard-title">Edit Award</h4>
                ...
                <div class="col-xxl-12">
                    <form action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <div class="custom-select">
                                                    ...
                                                    <input type="hidden" name="award_type" value="{{ $award_type }}">
                                                </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="gift" value="{{ $gift }}">
                                                @if ($errors->has('gift'))
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="cash" value="{{ $cash }}">
                                                @if ($errors->has('cash'))
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <div class="position-relative">
                                                    <input name="award_date" value="{{ $award_date }}" type="text"
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control"
                                                    name="award_information">{{ $award_information }}</textarea>
                        ...
                        <div class="fixed-bottom bg-white border-top p-3 d-flex justify-content-between align-items-center"
                            ...
                            <button type="submit" class="btn btn-theme-orange px-5 py-2">Save Award</button>
                        </div>
                    </form>
                </div>
