            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="mb-sm-0 dashboard-title">Payees</h4>
                ...
                <div class="col-lg-12">
                    <div class="card-theme">
                        <div class="card-header d-flex align-items-center justify-content-between">
                            ...
                            <a href="{{url('add-payee')}}" class="btn btn-theme-orange">Add Payee</a>
                        </div>
                                ...
                                <table id="buttons-datatables" class="display table konnect-table mb-0"
                                   ...
                                   ?>
                                        <tr>
                                            ...
                                            <td class="ps-4">{{$payee->name}} </td>
                                            <td class="">{{$payee->telephone}} </td>
                                            {{-- <td class="">{{$payee->created_at}} </td> --}}
                                            <td class="text-center">
                                                <div class="d-flex justify-content-center gap-2">
                                                    <a href="{{ url('edit-finance-payee/' . $payee->id) }}"
                                                    ...
                                                    <a href="{{ url('delete-finance-payee/' . $payee->id) }}"
