            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="mb-sm-0 dashboard-title">Add HR Manager</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Dashboard</a></li>
                                <li class="breadcrumb-item active">Add HR Manager</li>
                            </ol>
                        </div>
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card card-theme shadow-none rounded-3 border-0"
                            ...
                            <div class="card-header border-0 bg-white p-4">
                                <h4 class="card-title mb-0 dashboard-title">HR Manager Details</h4>
                            </div>
                                                ...
                                                <div class="custom-select">
                                                    ...
                                                    <ul class="select-dropdown hidden">
                                                        ...
                                                        @foreach ($admins as $admin)
                                                            <li data-value="{{ $admin->id }}">
                                                                <?php    echo OtherAdminDetails::where('user_id', $admin->id)->value('first_name') . ' ' . OtherAdminDetails::where('user_id', $admin->id)->value('last_name') . ' (Admin)'; ?>
                                                            </li>
                                                        @endforeach
                                                    </ul>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-check mb-3">
                                                <input class="form-check-input orange-checked" type="checkbox"
                                                    id="activeHRManager" checked="checked" name="status">
                        ...
                        <div class="fixed-bottom bg-white border-top p-3 d-flex justify-content-between align-items-center"
                            ...
                            <button type="submit" class="btn btn-theme-orange px-5 py-2">Save as HR Manager</button>
                        </div>
