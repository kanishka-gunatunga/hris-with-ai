            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="mb-sm-0 dashboard-title">Edit Authorizer</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Dashboard</a></li>
                                <li class="breadcrumb-item active">Edit Authorizer</li>
                            </ol>
                        </div>
                ...
                <div class="col-lg-12">
                    <div class="card card-theme shadow-none rounded-3 border-0">
                        <div class="card-header border-0 bg-white p-4">
                            <h5 class="card-title mb-0 dashboard-title">Edit Authorizer</h5>
                                                ...
                                                <div class="col-lg-10">
                                                    <div class="tab-content text-muted mt-3 mt-lg-0">
                                                        <div class="tab-pane fade active show" id="subtab1"
                                                            ...
                                                            <form method="POST"
                                                                action="{{ url('edit-authoriser-basic/' . $id) }}"
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="mb-3">
                                                                            <label
                                                                                class="form-label text-[#556476] font-medium">Name</label>
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        <div class="form-check mb-3">
                                                                            <input
                                                                                ...
                                                                                type="checkbox" id="activeAuthorizer"
                                                                                {{$check}} name="status">
                                                                            <label
                                                                                class="form-check-label text-[#556476] font-medium"
                                                                                for="activeAuthorizer">
                                                                                Active Authorizer
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="fixed-bottom bg-white border-top p-3 d-flex justify-content-between align-items-center"
                                                                    ...
                                                                    <button type="button"
                                                                        ...
                                                                        onclick="window.location.href='{{ url('authorisers') }}'">Back</button>
                                                                    <button type="submit"
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-12">
                                                                            ...
                                                                            <form method="POST"
                                                                                ...
                                                                                <div class="modal-content">
                                                                                    <div class="modal-header">
                                                                                        <h5 class="modal-title dashboard-title"
                                                                                    ...
                                                                                    <div class="modal-body">
                                                                                        ...
                                                                                        <div class="row">
                                                                                            <div class="col-md-4">
                                                                                                <div class="mb-3">
                                                                                                    <label
                                                                                                        class="form-label text-[#556476] font-medium">Document
                                                                                                        Number</label>
                                                                                                    <input type="text"
                                                                                                        class="form-control"
                                                                                                        name="document_no"
                                                                                            ...
                                                                                            <div class="col-md-4">
                                                                                                <div class="mb-3">
                                                                                                    <label
                                                                                                        class="form-label text-[#556476] font-medium">Issue
                                                                                                        Date</label>
                                                                                                    <div
                                                                                            ...
                                                                                            <div class="col-md-4">
                                                                                                <div class="mb-3">
                                                                                                    <label
                                                                                                        class="form-label text-[#556476] font-medium">Eligible
                                                                                                        Review
                                                                                                        Date</label>
                                                                                                    <div
                                                                                                        class="position-relative">
                                                                    ...
                                                                    <table id="buttons-datatables"
                                                                        class="display table konnect-table"
                                                                        style="width:100%">
                                                                        <thead>
                                                                            <tr>
                                                                                    ...
                                                                                    <div class="modal-body">
                                                                                        ...
                                                                                        <div class="row">
                                                                                            <div class="col-md-4">
                                                                                                <div class="mb-3">
                                                                                                    <label
                                                                                                        class="form-label text-[#556476] font-medium">Relation</label>
                                                                                                    <div
                                                                                                        class="custom-select">
                                                                                                        <button
                                                                                                            type="button"
                                                                                            ...
                                                                                            <div class="col-md-4">
                                                                                                <div class="mb-3">
                                                                                                    <label
                                                                                                        class="form-label text-[#556476] font-medium">E-Mail
                                                                                                        Work</label>
                                                                                                    <input type="email"
                                                                                                        class="form-control"
                                                                                                        name="email_work"
                                                                                            ...
                                                                                            <div class="col-md-4">
                                                                                                <div class="mb-3">
                                                                                                    <label
                                                                                                        class="form-label text-[#556476] font-medium">Address
                                                                                                        Line 1</label>
                                                                                                    <input type="text"
                                                                                                        class="form-control"
                                                                                                        name="address_line1"
                ...
                ?>
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="mb-3">
                                                                            <label
                                                                                class="form-label text-[#556476] font-medium">Facebook
                                                                                Profile</label>
                                                                            <input type="text" class="form-control"
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="mb-3">
                                                                            <label
                                                                                class="form-label text-[#556476] font-medium">Profile</label>
                                                                            <input type="text" class="form-control"
                                                                                name="skype_profile"
                                                                                value="{{$skype_profile }}">
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="mb-3">
                                                                            <label
                                                                                class="form-label text-[#556476] font-medium">LinkedIn
                                                                                Profile</label>
                                                                            <input type="text" class="form-control"
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="mb-3">
                                                                            <label
                                                                                class="form-label text-[#556476] font-medium">Twitter
                                                                                Profile</label>
                                                                            <input type="text" class="form-control"
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="mb-3">
                                                                            <label
                                                                                class="form-label text-[#556476] font-medium">Whats
                                                                                App
                                                                                Profile</label>
                                                                            <input type="text" class="form-control"
                                                                                    ...
                                                                                    <div class="modal-body">
                                                                                        ...
                                                                                        <div class="row">
                                                                                            ...
                                                                                            <div class="col-md-4">
                                                                                                <div class="mb-3">
                                                                                                    <label
                                                                                                        class="form-label text-[#556476] font-medium">Document</label>
                                                                                                    <input type="file"
                                                                                                        class="form-control"
                                                                                                        name="document"
                                                                                                        required>
                                                                                    ...
                                                                                    <div class="modal-body">
                                                                                        ...
                                                                                        <div class="row">
                                                                                            <div class="col-md-4">
                                                                                                <div class="mb-3">
                                                                                                    <label
                                                                                                        class="form-label text-[#556476] font-medium">School/University</label>
                                                                                                    <input type="text"
                                                                                                        class="form-control"
                                                                                            ...
                                                                                            <div class="col-md-4">
                                                                                                <div class="mb-3">
                                                                                                    <label
                                                                                                        class="form-label text-[#556476] font-medium">Education
                                                                                                        Level</label>
                                                                                                    <div
                                                                                                        class="custom-select">
                                                                                                        <button
                                                                                            ...
                                                                                            <div class="col-md-4">
                                                                                                <div class="mb-3">
                                                                                                    <label
                                                                                                        class="form-label text-[#556476] font-medium">Language</label>
                                                                                                    <div
                                                                                                        class="custom-select">
                                                                                                        <button
                                                                                                            type="button"
                                                                                            ...
                                                                                            <div class="col-md-4">
                                                                                                <div class="mb-3">
                                                                                                    <label
                                                                                                        class="form-label text-[#556476] font-medium">Professional
                                                                                                        Skills</label>
                                                                                                    <div
                                                                                                        class="custom-select">
                                                                                                        <button
                                                                                    ...
                                                                                    <div class="modal-body">
                                                                                        ...
                                                                                        <div class="row">
                                                                                            <div class="col-md-4">
                                                                                                <div class="mb-3">
                                                                                                    <label
                                                                                                        class="form-label text-[#556476] font-medium">Company</label>
                                                                                                    <input type="text"
                                                                                                        class="form-control"
                                                                                                        name="company"
                                                                                                        value="">
                                                                                            ...
                                                                                            <div class="col-md-4">
                                                                                                <div class="mb-3">
                                                                                                    <label
                                                                                                        class="form-label text-[#556476] font-medium">Post</label>
                                                                                                    <input type="text"
                                                                                                        class="form-control"
                                                                                                        name="post"
                                                                                                        value="">
                                                                                    ...
                                                                                    <div class="modal-body">
                                                                                        ...
                                                                                        <div class="row">
                                                                                            <div class="col-md-4">
                                                                                                <div class="mb-3">
                                                                                                    <label
                                                                                                        class="form-label text-[#556476] font-medium">Account
                                                                                                        Title</label>
                                                                                                    <input type="text"
                                                                                                        class="form-control"
                                                                                                        name="account_title"
                                                                                            ...
                                                                                            <div class="col-md-4">
                                                                                                <div class="mb-3">
                                                                                                    <label
                                                                                                        class="form-label text-[#556476] font-medium">Bank
                                                                                                        Name</label>
                                                                                                    <input type="text"
                                                                                                        class="form-control"
                                                                                                        name="bank_name"
                                    ...
                                    <div class="tab-pane" id="tab2" role="tabpanel">
                                        ...
                                        <form method="POST" action="{{ url('change-authoriser-image/' . $id) }}"
                                            enctype="multipart/form-data">
                                            @csrf
                                            ...
                                            <div class="row mt-4">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        <label class="form-label text-[#556476] font-medium">Profile
                                                            Image</label>
                                                                                    ...
                                                                                    <div class="modal-body">
                                                                                        ...
                                                                                        <div class="row">
                                                                                            ...
                                                                                            <div class="col-md-4">
                                                                                                <div class="mb-3">
                                                                                                    <label
                                                                                                        class="form-label text-[#556476] font-medium">Payslip
                                                                                                        Type</label>
                                                                                                    <div
                                                                                                        class="custom-select">
                                                                                                        <button
                                                                                            ...
                                                                                            <div class="col-md-4">
                                                                                                <div class="mb-3">
                                                                                                    <label
                                                                                                        class="form-label text-[#556476] font-medium">Basic
                                                                                                        Salary</label>
                                                                                                    <input type="text"
                                                                                                        class="form-control"
                                                                                                        name="basic_salary"
                                                                                    ...
                                                                                    <div class="modal-body">
                                                                                        ...
                                                                                        <div class="row">
                                                                                            ...
                                                                                            <div class="col-md-4">
                                                                                                <div class="mb-3">
                                                                                                    <label
                                                                                                        class="form-label text-[#556476] font-medium">Allowance
                                                                                                        Type</label>
                                                                                                    <div
                                                                                                        class="custom-select">
                                                                                                        <button
                                                                                    ...
                                                                                    <div class="modal-body">
                                                                                        ...
                                                                                        <div class="row">
                                                                                            ...
                                                                                            <div class="col-md-4">
                                                                                                <div class="mb-3">
                                                                                                    <label
                                                                                                        class="form-label text-[#556476] font-medium">Commission
                                                                                                        Title</label>
                                                                                                    <input type="text"
                                                                                                        class="form-control"
                                                                                    ...
                                                                                    <div class="modal-body">
                                                                                        ...
                                                                                        <div class="row">
                                                                                            ...
                                                                                            <div class="col-md-4">
                                                                                                <div class="mb-3">
                                                                                                    <label
                                                                                                        class="form-label text-[#556476] font-medium">Loan
                                                                                                        Option</label>
                                                                                                    <div
                                                                                                        class="custom-select">
                                                                                                        <button
                                                                                            ...
                                                                                            <div class="col-md-4">
                                                                                                <div class="mb-3">
                                                                                                    <label
                                                                                                        class="form-label text-[#556476] font-medium">Number
                                                                                                        of
                                                                                                        Installments</label>
                                                                                                    <input type="number"
                                                                                                        class="form-control"
                                                                                    ...
                                                                                    <div class="modal-body">
                                                                                        ...
                                                                                        <div class="row">
                                                                                            ...
                                                                                            <div class="col-md-4">
                                                                                                <div class="mb-3">
                                                                                                    <label
                                                                                                        class="form-label text-[#556476] font-medium">Deduction
                                                                                                        Option</label>
                                                                                                    <div
                                                                                                        class="custom-select">
                                                                                                        <button
                                                                                    ...
                                                                                    <div class="modal-body">
                                                                                        ...
                                                                                        <div class="row">
                                                                                            ...
                                                                                            <div class="col-md-4">
                                                                                                <div class="mb-3">
                                                                                                    <label
                                                                                                        class="form-label text-[#556476] font-medium">Total
                                                                                                        Hours</label>
                                                                                                    <input type="text"
                                                                                                        class="form-control"
                                                                                                        name="total_hours"
                                                                                            ...
                                                                                            <div class="col-md-4">
                                                                                                <div class="mb-3">
                                                                                                    <label
                                                                                                        class="form-label text-[#556476] font-medium">Rate</label>
                                                                                                    <input type="text"
                                                                                                        class="form-control"
                                                                                                        name="rate"
                                                                                                        value="">
                                                                        ...
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <div class="custom-select">
                                                                                <button type="button"
                                                                                    class="select-button">
                                                                                    <span
                                                                                        class="selected-value">{{ $pansion_type ?: 'Pansion Type' }}</span>
                                                                                    <span class="arrow"><i
                                                                                            class="ri-arrow-down-s-line"></i></span>
                                                                                </button>
                                                                                <ul class="select-dropdown hidden">
