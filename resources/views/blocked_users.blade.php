            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="mb-sm-0 dashboard-title">Blocked Users</h4>
                ...
                <div class="col-lg-12">
                    <div class="card card-theme shadow-none rounded-3 border-0">
                        <div
                            ...
                            <h5 class="card-title mb-0 dashboard-title">Blocked Users List</h5>
                        </div>
                                ...
                                <table id="buttons-datatables" class="display table konnect-table mb-0"
                                    ...
                                    <tbody>
                                        @foreach ($users as $user)
                                                                                <?php
                                            $user_role = match ($user->user_role) {
                                                1 => 'Admin',
                                                2 => 'HRM',
                                                3 => 'Employee',
                                                4 => 'Client',
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="text-center">
                                                                                        <div class="d-flex justify-content-center gap-2">
                                                                                            <a href="{{ url('unblock-user/' . $user->id) }}"
                                                                                                class="btn-icon-soft-green" title="Unblock">
