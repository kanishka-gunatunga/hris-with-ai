...
foreach ($type_details as $type_detail) {
    $leave_type = $type_detail->leave_type;
    $leave_available = $type_detail->leave_available;
    $leave_count = $type_detail->leave_count;
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="mb-sm-0 dashboard-title">Edit Leave Type</h4>
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card card-theme shadow-none rounded-3 border-0"
                            ...
                            <div class="card-header border-0 bg-white p-4">
                                <h4 class="card-title mb-0 dashboard-title">Edit Leave Type</h4>
                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="custom-select">
                                                    <button type="button" class="select-button">
                                                        <span
                                                            class="selected-value">{{ $leave_available ? ucfirst($leave_available) : 'Select Availability' }}</span>
