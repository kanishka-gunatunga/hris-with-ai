            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="mb-sm-0 dashboard-title">Add Payer</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Dashboard</a></li>
                                <li class="breadcrumb-item active">Add Payer</li>
                            </ol>
                        </div>
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card card-theme shadow-none rounded-3 border-0">
                            <div class="card-header border-0 bg-white p-4">
                                <h4 class="card-title mb-0 dashboard-title">Add Payer</h4>
                            </div>
                        ...
                        <div class="fixed-bottom bg-white border-top p-3 d-flex justify-content-between align-items-center"
                            ...
                            <button type="button" class="btn btn-outline-secondary px-4 py-2 action-btn-back"
                                ...
                                onclick="window.location.href='{{ url('finance-payer') }}'">Back</button>
                        ...
                        <style>
                            ...
                            /* Custom Orange Theme for Choices.js and inputs */
