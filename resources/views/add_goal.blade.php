            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="mb-sm-0 dashboard-title">Add Goal Tracking</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Dashboard</a></li>
                                <li class="breadcrumb-item active">Add Goal Tracking</li>
                            </ol>
                        </div>
                                                ...
                                                <div class="custom-select">
                                                    <button type="button" class="select-button">
                                                        <span class="selected-value">
                                                            @if(old('goal_type'))
                                                                {{ PerformanceGoalType::where('id', old('goal_type'))->value('goal_type') }}
                                                            @else
                                                                Select Goal Type
                                                            @endif
                                                        </span>
                                                    ...
                                                    <ul class="select-dropdown hidden">
                                                        @foreach($goal_types as $goal_type)
                                                            <li data-value="{{$goal_type->id}}">{{$goal_type->goal_type}}
                                                            </li>
                                                        @endforeach
                                                    </ul>
