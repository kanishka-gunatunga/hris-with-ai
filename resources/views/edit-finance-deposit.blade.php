...
foreach ($deposit_details as $deposit_detail) {
    ...
    $account = $deposit_detail->account;
    $category = $deposit_detail->category;
    $amount = $deposit_detail->amount;
    $date = $deposit_detail->date;
    $payer = $deposit_detail->payer;
    $reference_no = $deposit_detail->reference_no;
    $discription = $deposit_detail->discription;
    $payment_mode = $deposit_detail->payment_mode;

    $account_name = FinanceAccountList::where('id', $account)->value('account_name');
    $payer_name = FinancePayer::where('id', $payer)->value('name');
}
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="mb-sm-0 dashboard-title">Edit Deposit</h4>
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card card-theme shadow-none rounded-3 border-0">
                            <div class="card-header border-0 bg-white p-4">
                                <h4 class="card-title mb-0 dashboard-title">Deposit Details</h4>
                            </div>
                            ...
                            <div class="card-body p-4 pt-0" style="min-height: 300px;">
                                ...
                                <div class="live-preview">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <label class="form-label text-[#556476] font-medium">Payer</label>
                                                <div class="custom-select">
                                                    <button type="button" class="select-button">
                                                        <span class="selected-value">{{ $payer_name }}</span>
                                                        <span class="arrow">
                                                            <i class="ri-arrow-down-s-line"></i>
                                                        </span>
                                                    </button>
                        ...
                        <div class="fixed-bottom bg-white border-top p-3 d-flex justify-content-between align-items-center"
                            ...
                            <button type="submit" class="btn btn-theme-orange px-5 py-2">Save Deposit</button>
                        </div>
                    </form>
                </div> <!-- end col -->
            </div>
