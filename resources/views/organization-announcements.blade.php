...
<div class="main-content">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="mb-sm-0 dashboard-title">Announcements</h4>
                ...
                <div class="col-lg-12">
                    <div class="card card-theme shadow-none rounded-3 border-0">
                        <div
                            ...
                            <h5 class="card-title mb-0 dashboard-title">Announcements List</h5>
                            <link href="https://fonts.googleapis.com/css2?family=Roboto:wght@400;700&display=swap"
                                rel="stylesheet">
                            <a href="{{url('add-announcement')}}" class="btn btn-theme-orange">Add Announcement</a>
                        </div>
    ...
    $dep_name = OrganizationDepartments::where('id', $announcement->department)->value('department');
    $department_location = OrganizationDepartments::where('id', $announcement->department)->value('location');
    $selected_location_name = OrganizationLocations::where('id', $department_location)->value('location');
                                    ?>
                                        <tr>
                                            <td class="ps-4">{{$announcement->title}} </td>
                                            <td>{{$dep_name . ' (' . $selected_location_name . ')'}}</td>
                                            <td>{{$announcement->start_date}} </td>
                                            <td>{{$announcement->end_date}} </td>
                                            <td class="text-center">
                                                <div class="d-flex justify-content-center gap-2">
                                                    <a href="{{ url('edit-organization-announcements/' . $announcement->id) }}"
                                                    ...
                                                    <a href="{{ url('delete-organization-announcements/' . $announcement->id) }}"
