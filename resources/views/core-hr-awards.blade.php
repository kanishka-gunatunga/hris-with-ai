...
<div class="main-content">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="mb-sm-0 dashboard-title">Awards</h4>
                ...
                <div class="col-lg-12">
                    <div class="card card-theme shadow-none rounded-3 border-0">
                        <div
                            ...
                            <h5 class="card-title mb-0 dashboard-title">Awards List</h5>
                            <link href="https://fonts.googleapis.com/css2?family=Roboto:wght@400;700&display=swap"
                                rel="stylesheet">
                            <a href="{{url('add-award')}}" class="btn btn-theme-orange">Add Award</a>
                        </div>
    ...
    $emp_name = OtherEmployeeDetails::where('user_id', $award->employee)->value('first_name') . ' ' . OtherEmployeeDetails::where('user_id', $award->employee)->value('last_name');
    $depatment_name = OrganizationDepartments::where('id', $award->department)->value('department');
    $department_location = OrganizationDepartments::where('id', $award->department)->value('location');
    $selected_location_name = OrganizationLocations::where('id', $department_location)->value('location');
                                    ?>
                                        <tr>
                                            ...
                                            <td>{{$depatment_name . ' (' . $selected_location_name . ')'}}</td>
                                            <td>{{$award->award_date}} </td>
                                            <td class="text-center">
                                                <div class="d-flex justify-content-center gap-2">
                                                    <a href="{{ url('edit-core-hr-award/' . $award->id) }}"
                                                    ...
                                                    <a href="{{ url('delete-core-hr-award/' . $award->id) }}"
