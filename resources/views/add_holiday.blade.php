            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="mb-sm-0 dashboard-title">Add Holiday</h4>
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card card-theme shadow-none rounded-3 border-0"
                            ...
                            <div class="card-header border-0 bg-white p-4">
                                <h4 class="card-title mb-0 dashboard-title">Add Holiday</h4>
                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="custom-select">
                                                    ...
                                                    <ul class="select-dropdown hidden">
                                                        ...
                                                        <!-- Fixed typo in label, kept value as in original if needed? Or original had "Publsihed". Assuming typo in original value too. Let's keep original value to be safe but fix label -->
